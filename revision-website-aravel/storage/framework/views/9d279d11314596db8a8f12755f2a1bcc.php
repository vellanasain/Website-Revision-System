...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Revisi Website'); ?></title>
    <link rel="stylesheet" href="<?php echo e(asset('css/revision-ui.css')); ?>">
    <script src="<?php echo e(asset('js/revision-ui.js')); ?>" defer></script>
</head>
<body>
    <div class="app-shell">
        <aside class="rail" aria-label="Navigasi utama">
            <div class="rail-top">
                <a class="rail-logo" href="<?php echo e(route('revisions.index')); ?>" title="Smartchat" aria-label="Smartchat">
                    <img 
                        src="<?php echo e(asset('images/logo-smartchat.webp')); ?>" 
                        alt="Smartchat Logo"
                        class="smartchat-logo-img"
                    >
                </a>
                <a class="rail-nav-button is-active" href="<?php echo e(route('revisions.index')); ?>" title="Data revisi" aria-label="Data revisi">
        ...
        <div class="page-shell">
            <header class="topbar">
                <div>
                    <h1><?php echo $__env->yieldContent('page_title', 'Daftar Revisi Website'); ?></h1>
...
<?php /**PATH D:\UI Revisi Web\revision-website-aravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>